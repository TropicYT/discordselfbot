...
1. Открой Discord в браузере (`https://discord.com/app`)  
2. Открой DevTools (`F12`) -> вкладка `Network`  
3. Включи/обнови свой стрим-статус, чтобы Discord подгрузил картинку  
4. В `Network` найди запрос к CDN с картинкой (`cdn.discordapp.com/app-assets/...`)  
5. Нажми на этот запрос и скопируй ID из имени файла (цифры перед `.png/.webp`)  
6. Вставь этот ID в `game.json -> stream.image`

Пример:
- URL: `https://cdn.discordapp.com/app-assets/123456789012345678/1496575614440833104.png`
- ID картинки: `1496575614440833104`

Иллюстрация (замени на свой скрин):
